...
from osint_stringUtils import insertStringBetween
  ...
  for memberExcludePattern in memberExcludePatterns:
    ...
    for startPattern in startPatterns:
      ...
      for endPattern in endPatterns:
        possibleMember = getStringBetween(URL, startPattern, endPattern)
...
def makeURLUnclickableForMarkdown(URL):

  return insertStringBetween(URL, "ht" , "tp" , "<span></span>")
